...
const resolvers = {
    ...
    Mutation: {
        ...
        async editProduct(_, { id, newProducts: { productName, category, brand, price, weight, color, description } }) {
            const wasEdited = await productDeatails.updateOne({ _id: new ObjectId(id) }, { productName: productName, category: category, brand: brand, price: price, weight: weight, color, description }).modifiedCount;
            return wasEdited;
        }
