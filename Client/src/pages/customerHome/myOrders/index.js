...
export default function Myorders() {
    ...
    console.log("customerOrders && customerOrders.getCustomerOrders", customerOrders && customerOrders.getCustomerOrders);
    return (
        <div>
                    ...
                    <tbody className=''>
                        {
                            ...
                            (
                                <tr className="border hover:bg-white hover:rounded-t-full border-b-gray-300 transition-all duration-300 ease-in-out" key={index}>
                                    ...
                                    <td className="text-center text-gray-700 font-medium hover:cursor-pointer" role="cell"><Link href={`/customerHome/myOrders/viewOrders/${orders._id}`}><FontAwesomeIcon icon={faEye} /></Link></td>
